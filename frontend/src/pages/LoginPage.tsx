  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-700 p-4">
      <Card className="w-full max-w-sm">
        <h1 className="mb-1 text-xl font-bold text-brand-700">Qeedha Accounting</h1>
        <p className="mb-5 text-sm text-slate-500">تسجيل الدخول إلى مساحة عملك المحاسبية</p>
          ...
          <div className="space-y-3">
            ...
            {tenantChoice.availableCompanies.map((c) => (
              <button
                ...
                disabled={loading}
                className="block w-full rounded-md border border-slate-300 px-3 py-2 text-right text-sm hover:border-brand-500 hover:bg-brand-50"
              >
